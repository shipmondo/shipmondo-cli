...
app = typer.Typer(help="Manage pick_lists")

@app.command("list")
def list_cmd(
    ids: str = typer.Option(None, "--ids", help="A list of sales order IDs that you want to fetch pick lists for. Examples 10075,10076,10077 "),
    output_format: str = typer.Option(None, "--output-format", help="Format for the pick lists. Available: a4_pdf, 10x19_pdf "),
    ...
    if help_json:
        print("""{
  "command": "shipmondo pick_lists list",
